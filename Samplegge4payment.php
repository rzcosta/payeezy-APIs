...
<?php
$x_login = "WSP-RZ-IN-Wm9WTgBoAA"; // Take from Payment Page ID in Payment Pages interface
$transaction_key = "Gr7MHGj69ijbmXS86mIG"; // Take from Payment Pages configuration interface
