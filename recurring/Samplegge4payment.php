...
<?php
$x_login = "WSP-RZ-IN-nFPttwBq@Q"; // Take from Payment Page ID in Payment Pages interface
$transaction_key = "AJJJmz_dseBy2wkVyaPN"; // Take from Payment Pages configuration interface
...
$x_recurring_billing_start_date = $_POST["x_recurring_start_date"];
$x_recurring_billing_end_date = $_POST["x_recurring_start_date"];
$x_recurring_billing = "TRUE";
$x_recurring_id = "MB-RZ-IN-70-7111";
$x_recurring_billing_start_date = "x_recurring_billing_start_date";
$x_recurring_billing_end_date = "x_recurring_billing_end_date";
$x_recurring_billing_amount = "x_recurring_billing_amount";
