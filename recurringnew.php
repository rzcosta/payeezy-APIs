...
*/
	...
	$myorder["port"]       = "1129";
	$myorder["keyfile"]    = ".pem"; # Change this to the name and location of your certificate file 
	$myorder["configfile"] = "";        # Change this to your store number 
